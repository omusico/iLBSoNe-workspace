...
//				Crashlytics.logException(e);
	...
	private void uploadPhotoService(String file) {
		...
		ApiClent.uploadFile(appContext.getLoginApiKey(), file, new ClientCallback() {
			...
			public void onSuccess(Object data) {
				...
				modify("", head, "",new ClientCallback() {
	...
	private void modify(String nickname, String head, String des, final ClientCallback callback) {
		...
		ApiClent.modifiedUser(appContext, appContext.getLoginApiKey(), nickname, head, des, new ClientCallback() {
			...
			public void onSuccess(Object data) {
				...
				String userHead=(String)data;
				UserEntity userwr = appContext.getLoginInfo();
				String userid=userwr.userInfo.userId;
				
				ContentValues contentValues = new ContentValues();
				contentValues.put("avatar", userHead);
				st.updateById("im_friend", userid, contentValues);
				showToast("保存成功！");
	...
	private void initTextEditDialog() {
		...
		builder.setPositiveButton(R.string.sure, new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				fieldAdapter.notifyDataSetChanged();
				modify(ed.getText().toString(), "", "",new ClientCallback() {
