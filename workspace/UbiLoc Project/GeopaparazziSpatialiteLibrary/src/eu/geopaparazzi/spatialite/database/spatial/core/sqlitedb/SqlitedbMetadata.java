...
public class SqlitedbMetadata {
    ...
    /**
      ...
      */
    public SqlitedbMetadata( String name, String description, String type, String version, String format, float[] bounds,
    ...
    /**
      ...
      */
    public static SqlitedbMetadata createFromCursor( Cursor c, int idx_col_key, int idx_col_value, MetadataValidator validator )
    ...
    public static interface MetadataValidator {
        SqlitedbMetadata validate( Map<String, String> hm ) throws MetadataParseException;
    }
    ...
    public static class MetadataValidator_1_1 implements MetadataValidator {
        @Override
        public SqlitedbMetadata validate( Map<String, String> hm ) throws MetadataParseException {
            String tmp;
            ...
            return new SqlitedbMetadata(name, description, type, version, format, bounds, center, minZoom, maxZoom,
                    s_tile_row_type, hm);
        }
    }
