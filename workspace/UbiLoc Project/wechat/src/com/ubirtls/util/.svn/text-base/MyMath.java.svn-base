...
public class MyMath {
	...
	/**子序列浅拷贝*/
	public static ArrayList<double[]> cloneSubList(ArrayList<double[]> datas, int start, int end){
	...
	/**子序列浅拷贝*/
	public static List<Double> cloneSubList(List<Double> datas, int start, int end){
		ArrayList<Double> result = new ArrayList<Double>();
		for (int i = start; i <= end; i++){
			result.add(datas.get(i));
		}
	...
	/**子序列浅拷贝*/
	public static ArrayList<Double> cloneSubListFirst(ArrayList<double[]> datas, int start, int end){
		ArrayList<Double> result = new ArrayList<Double>();
		for (int i = start; i <= end; i++){
