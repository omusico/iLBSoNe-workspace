...
public class Chating extends AChating implements OnTouchListener, OnItemClickListener, VoiceBubbleListener, OnEditorActionListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ApiClent.getUserInfo(apiKey, to.split("@")[0], new ClientCallback() {
...
//				.getChatCountWithSb(to);
	...
	private class MessageListAdapter extends BaseAdapter {
		...
		class ViewHolderLeftImage {
			TextView timeTV;
			ImageView leftAvatar;//Chating聊天界面左边用户图像
			TextView leftNickname;
			ImageView leftPhoto;
...
//			.showImageOnFail(R.drawable.content_image_loading)
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			//========为	ViewHolderLeftImage添加onclick事件===========
			/*holderLeftImg.leftAvatar.setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Toast.makeText(appContext, "我点左边的你了！", Toast.LENGTH_LONG).show();
				}
			});*/
			//=====================================================
				...
				if (convertView == null) {
					if (message.getMsgType() == 0) {
						...
						case CommonValue.kWCMessageTypePlain:
							...
							break;
						case CommonValue.kWCMessageTypeImage://调试发现不会运行这部分代码
							...
							holderLeftImg.leftAvatar.setOnClickListener(new OnClickListener() {
								...
								public void onClick(View v) {
									// TODO Auto-generated method stub
									Toast.makeText(Chating.this, "我点左边的你了！", Toast.LENGTH_LONG).show();
								}
							});
