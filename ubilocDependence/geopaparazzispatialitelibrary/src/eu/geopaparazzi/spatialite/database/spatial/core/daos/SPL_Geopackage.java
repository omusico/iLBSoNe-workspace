...
public class SPL_Geopackage {
                ...
                if (vector_extent != null) {
                    ...
                    if (vector_key.contains("GeoPackage_features")) {
                        ...
                        if (sa_string.length == 5) {
                            ...
                            HashMap<String, String> fieldNamesToTypeMap = DaoSpatialite.collectTableFields(database, s_vgpkg
                                    + table_name);
     ...
     * @throws jsqlite.Exception if something goes wrong.
     */
    private static int spatialiteAutoGPKG( Database database, int i_stop, SpatialiteDatabaseType databaseType )
