...
public class ShapeWriter {
     ...
     */
    public static final PointShapeFactory DEFAULT_POINT_FACTORY = new PointShapeFactory.Circle(8.0);
    ...
    private static PointShapeFactory getShape( String shapeName, float size ) {
        ...
        } else if (shapeName.equals("POP")) {
            return new PointShapeFactory.POP(size);
        } else {
