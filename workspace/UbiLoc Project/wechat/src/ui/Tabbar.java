...
public class Tabbar extends TabActivity implements OnCheckedChangeListener{
	...
	private final static String TAB_TAG_FIND = "tab_tag_find";
	...
	private void prepareIntent() {
		...
		findFriendIntent = new Intent(this, UbilocMapActivity.class);
		//mapIntent=new Intent(this,UbilocMapActivity.class);
	}
	...
	private void setupIntent() {
		...
		localTabHost.addTab(buildTabSpec(TAB_TAG_FIND, R.string.main_map, R.drawable.tabbar_button3, findFriendIntent));
		//localTabHost.addTab(buildTabSpec(TAB_TAG_FIND, R.string.main_map, R.drawable.tabbar_button3, mapIntent));
