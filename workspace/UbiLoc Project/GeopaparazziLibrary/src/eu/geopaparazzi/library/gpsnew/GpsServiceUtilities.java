 ...
 */
package eu.geopaparazzi.library.gpsnew;

import static eu.geopaparazzi.library.gpsnew.GpsService.GPS_LOGGING_STATUS;
import static eu.geopaparazzi.library.gpsnew.GpsService.GPS_SERVICE_BROADCAST_NOTIFICATION;
import static eu.geopaparazzi.library.gpsnew.GpsService.GPS_SERVICE_DO_BROADCAST;
import static eu.geopaparazzi.library.gpsnew.GpsService.GPS_SERVICE_GPSSTATUS_EXTRAS;
import static eu.geopaparazzi.library.gpsnew.GpsService.GPS_SERVICE_POSITION;
import static eu.geopaparazzi.library.gpsnew.GpsService.GPS_SERVICE_POSITION_EXTRAS;
import static eu.geopaparazzi.library.gpsnew.GpsService.GPS_SERVICE_POSITION_TIME;
import static eu.geopaparazzi.library.gpsnew.GpsService.GPS_SERVICE_STATUS;
import static eu.geopaparazzi.library.gpsnew.GpsService.START_GPS_LOGGING;
import static eu.geopaparazzi.library.gpsnew.GpsService.START_GPS_LOG_HELPER_CLASS;
import static eu.geopaparazzi.library.gpsnew.GpsService.START_GPS_LOG_NAME;
import static eu.geopaparazzi.library.gpsnew.GpsService.STOP_GPS_LOGGING;
