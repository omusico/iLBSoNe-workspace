...
public abstract class AbstractSpatialTable implements Serializable {
    ...
    public boolean equals( Object o ) {
        if (o != null && o instanceof AbstractSpatialTable) {
            AbstractSpatialTable oTable = (AbstractSpatialTable) o;
            if (oTable.getDatabasePath().equals(this.getDatabasePath()) && oTable.getTableName().equals(this.getTableName())) {
                return true;
            } else {
                return false;
            }
    ...
    public int hashCode() {
        int result = 17;
        result = result * 37 + getDatabasePath().hashCode();
        result = result * 37 + getTableName().hashCode();
        return result;
    }
